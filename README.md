...
- [Faultline](https://smellybricc.github.io/faultline/) — deterministic distributed-systems failure lab
- [Signal Garden](https://smellybricc.github.io/signal-garden/) — local-only audio-reactive generative instrument
- [Second Order](https://smellybricc.github.io/second-order/) — seeded Monte Carlo decision laboratory
